var fullPage = function (e) {
  ...
  t.default = {
    ...
    data: function () {
      var e = this;
      return {
        events: a.EVENTS.reduce(function (t, n) {
    ...
    methods: {
      ...
      emitEvent: function (e, t) {
        this.$emit.apply(this, [(0, l.camelToKebab)(e)].concat(r(t))), this.options.hasOwnProperty(e) && this.options[e].apply(this, t)
      },
      update: function () {
  ...
  var s = n(5),
    a = n(2),
    l = a(o.a, s.a, !1, null, null, null);
  l.options.__file = "src/FullPage.vue", t.default = l.exports
}, function (e, t) {
